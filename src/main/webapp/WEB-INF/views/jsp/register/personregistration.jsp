				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<form:form class="form-signin form" role="form" method="POST" action="${post_url}" id="register_personregistration_form" modelAttribute="personRegistration">
							<form:label path="userLogin.id" for="register_personregistration_username">User name</form:label>
							<form:input path="userLogin.id" class="form-control" id="register_personregistration_username" placeholder="User name" type="text" />
							...
							<form:input path="userLogin.passwordHash" class="form-control" placeholder="Password" id="register_personregistration_password" autocomplete="off" type="password" />
							...
							<form:input path="person.firstName" class="form-control" placeholder="First Name" id="register_personregistration_firstname" type="text" />
