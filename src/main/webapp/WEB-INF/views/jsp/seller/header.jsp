...
<nav class="navbar navbar-default navbar-fixed-top header" role="navigation">
   ...
   <div>
   		<div>
   			<a class="header-nav-item" href="<c:url value='/seller/viewcategory/category/-1'/>" >Product</a>
   			<a class="header-nav-item" href="<c:url value='/seller/viewcontacts'/>" >Contact</a>
