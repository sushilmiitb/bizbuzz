						...
						<div class="panel-body">
							...
							<div class="list-group">
								<a href="#" class="list-group-item active">
									<h4 class="list-group-item-heading">Group Members</h4>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<form:form method="POST" action="${post_url}"
									id="seller_viewsinglegroup_form" class="form form-signin"
									modelAttribute="privateGroup">
									<form:label path="privateGroupName"
										for="seller_viewsinglegroup_groupname">Group Name</form:label>
									<form:input path="privateGroupName" class="form-control"
										id="seller_viewsinglegroup_groupname" type="text" />
									<input id="seller_viewsinglegroup_edit"
