   ...
   <script type="text/javascript">
      ...
      $(function() {
        ...
        request.onOpen = function(response){
          ...
          subSocket.push(JSON.stringify({"message":"0Open0","userId": ${userId},"chatroomId":${chatroomId}}));
        ...
        $('#message-button').click(function() {
          ...
          subSocket.push(JSON.stringify({"message":$('#message-field').val(),"userId": ${userId},"chatroomId":${chatroomId}}));
        });
      });
  </script>
